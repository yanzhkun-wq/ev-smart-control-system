...
export const MINIAPP_FEATURE_DEFS: MiniappFeatureDef[] = [
  ...
  { key: "profile_vip_entry", label: "我的·VIP 入口", group: "home" },
  { key: "profile_svc_tracks", label: "我的·行车记录", group: "vehicle" },
  ...
  { key: "profile_mall_module", label: "我的·「智控商城与升级」整区", group: "mall" },
  { key: "profile_mall_entry", label: "我的·智控商城入口", group: "mall" },
  { key: "profile_shops_entry", label: "我的·升级网点入口", group: "mall" },
  { key: "profile_partner_module", label: "我的·「合作与拓展」整区", group: "partner" },
  { key: "profile_share_invite", label: "我的·邀请好友", group: "invite" },
  { key: "profile_partner_apply", label: "我的·合作商申请", group: "partner" },
